...
export const STRINGS = {
  zh: {
    ...
    ph_ip: 'IP / CIDR / ASN，如 203.0.113.5、1.2.3.0/24、AS4538', ph_cc: '国家/地区（空=全表搜索）', ph_city: '城市（空=全国）',
    ...
    clear: '清空', src_home: '项目主页', feedback: '问题反馈',
  ...
  en: {
    ...
    ph_ip: 'IP / CIDR / ASN, e.g. 203.0.113.5, 1.2.3.0/24, AS4538', ph_cc: 'Country/region (empty = global)', ph_city: 'City (empty = all)',
    ...
    clear: 'Clear', src_home: 'Source', feedback: 'Issues',
