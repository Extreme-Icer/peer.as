...
export const STRINGS = {
  zh: {
    ...
    ph_ip: 'IP / CIDR / ASN / AS 名称，如 203.0.113.5、1.2.3.0/24、AS4538、阿里云', ph_cc: '国家/地区（空=全表搜索）', ph_city: '城市（空=全国）',
  ...
  en: {
    ...
    ph_ip: 'IP / CIDR / ASN / AS name, e.g. 203.0.113.5, 1.2.3.0/24, AS4538, Cloudflare', ph_cc: 'Country/region (empty = global)', ph_city: 'City (empty = all)',
