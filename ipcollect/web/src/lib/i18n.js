...
export const STRINGS = {
  zh: {
    ...
    ph_path: 'AS_PATH，如 23764 4809、1299 * 4538、!174（点 ? 看语法）', ph_origin: '如 4538', ph_limit: '上限',
  ...
  en: {
    ...
    ph_path: 'AS_PATH, e.g. 23764 4809, 1299 * 4538, !174 (click ? for syntax)', ph_origin: 'e.g. 4538', ph_limit: 'limit',
