...
export const STRINGS = {
  zh: {
    ...
    rpki_notfound: 'RPKI 未找到：此前缀无覆盖的 ROA（中性，非错误）',
    ...
    asset_tree_note: '点击子 as-set 可逐层展开其成员(登记的客户锥意图, 非观测拓扑); 仅展示一级成员、按需懒加载',
    ...
    asn_scanned: '扫描了 {n} 条前缀记录', asn_capped: '（已截断）', asn_neigh_pre: '全网邻接（导出期预计算，完整无截断）',
  ...
  en: {
    ...
    rpki_notfound: 'RPKI Not Found — no ROA covers this prefix (neutral, not an error)',
    ...
    asset_tree_note: 'click a child as-set to expand its members level by level (registered customer-cone intent, not observed topology); one level shown, lazy-loaded',
    ...
    asn_scanned: 'scanned {n} prefix records', asn_capped: ' (capped)', asn_neigh_pre: 'global adjacency (precomputed at export, complete & uncapped)',
