...
export const STRINGS = {
  zh: {
    ...
    nav_views: '视图', nav_routing: '路由分析', nav_whois: 'WHOIS',
    wv_ph: '输入 ASN / IP / 前缀 / 域名…',
    wv_go: '查询', wv_examples: '试试',
    wv_invalid: '无法识别 —— 请输入 ASN、IP、前缀或域名。',
    wv_asset_na: 'as-set 没有 WHOIS —— 请在「路由分析」视图展开其成员。',
  ...
  en: {
    ...
    nav_views: 'Views', nav_routing: 'Routing', nav_whois: 'WHOIS',
    wv_ph: 'Enter an ASN / IP / prefix / domain…',
    wv_go: 'Lookup', wv_examples: 'Try',
    wv_invalid: 'Unrecognized — enter an ASN, IP, prefix or domain.',
    wv_asset_na: 'as-sets have no WHOIS — expand members in the Routing view.',
