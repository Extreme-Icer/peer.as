<script>
  ...
  function pickHistory(tg) { box = tg; dropOpen = false; hi = -1; launch(tg) }
...
<style>
  ...
  .hist {
    position: absolute; z-index: 6; margin: 0; padding: 5px; list-style: none; max-height: 282px; overflow: auto;
