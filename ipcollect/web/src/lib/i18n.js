...
export const STRINGS = {
  zh: {
    ...
    asn_neigh: '完整邻居（全表扫描）', asn_neigh_btn: '全表扫描邻居',
    asn_neigh_note: '扫描全表 AS_PATH 求该 ASN 两侧邻居并分类，较慢（大型骨干尤甚）。',
  ...
  en: {
    ...
    sec_originated: 'Prefixes', sec_relations: 'Relationships', sec_neighbors: 'Neighbors',
    ...
    asn_rel: 'Observed relationships', asn_rel_note: 'Inferred from best-path direction of originated prefixes; the upstream side may include peers, ambiguous cases fall back to peer.',
    ...
    asn_neigh: 'Full neighbors (full-table scan)', asn_neigh_btn: 'Scan neighbors (full table)',
    asn_neigh_note: 'Scans all AS_PATHs for neighbors on both sides of this ASN and classifies them — slow (esp. large backbones).',
